     ...
     <!-- Nav Item - User Information -->
        <li class="nav-item dropdown no-arrow">
         <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
             data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
             <span class="mr-2 d-none d-lg-inline text-bg-light small"><?php echo $_SESSION['usuario_nombre'].' '. $_SESSION['usuario_apellido']; ?></span>
...
<!-- End of Topbar -->
                        ...
                        <div class="col d-flex justify-content-center">
                            <figure class="figure text-center">
                                <a href="formulario_Veterinario.html">
                                    <img src="imagenes/Home de Veterinario - Veterinario.jpg" class="figure-img img-fluid rounded" alt="..." id="img_home_vete">
                                </a>
                        ...
                        <div class="col d-flex justify-content-center">
                            <figure class="figure text-center">
                                <a href="formulario_Protectora_Animal.html">
                                    <img src="imagenes/Home de Veterinario - Protectora de Animales.jpg" class="figure-img img-fluid rounded" alt="..." id="img_home_vete">
                                </a>
                ...
                <div class="container-fluid text-center">
                    <h1 class="fw-bold p-2 fs-2 border-top border-3 w-50 mx-auto text-center pt-5 fw-bold" id="principal">NOTICIAS</h1>
                    <div class="container mt-5">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <p class="mt-4">La Municipalidad de Cruz del Eje se complace en anunciar una campaña de vacunación gratuita para animales de compañía. Esta iniciativa tiene como objetivo proteger la salud de nuestras mascotas y prevenir enfermedades comunes que pueden afectarlas.</p>
                                <h2 class="mt-4">Fechas y Horarios</h2>
                                <p>La campaña se llevará a cabo del <strong>1 al 15 de junio</strong>, en los siguientes horarios:</p>
                                ...
                                <p>Durante esta campaña, se ofrecerán las siguientes vacunas para perros y gatos:</p>
                                <ul class="sacarPelota">
                                    <li>Vacuna contra la rabia</li>
                                    <li>Vacuna quintuple (moquillo, parvovirus, hepatitis, leptospirosis, parainfluenza) para perros</li>
                                    <li>Vacuna triple felina (panleucopenia, rinotraqueitis, calicivirus) para gatos</li>
                                </ul>
                                <h2 class="mt-4">Requisitos</h2>
                                <p>Para recibir la vacunación, los propietarios deben cumplir con los siguientes requisitos:</p>
                                <ul class="sacarPelota">
                                ...
                                <p>Vacunar a su mascota es esencial para su salud y bienestar. Los beneficios incluyen:</p>
                                <ul class="sacarPelota">
                                    <li>Protección contra enfermedades graves</li>
                                    <li>Reducción del riesgo de transmisión de enfermedades a humanos y otros animales</li>
                                    <li>Contribución al control de enfermedades a nivel comunitario</li>
                                </ul>
                                <p class="mt-4">¡No pierda esta oportunidad de proteger a su mascota y mantenerla saludable! La vacunación es gratuita y segura.</p>
                                <p class="mt-4"><strong>Para más información, puede comunicarse con la Municipalidad de Cruz del Eje al teléfono (03549) 123-456 o visitar nuestra página web www.cruzdeleje.gob.ar.</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
