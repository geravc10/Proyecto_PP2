...
-->
                ...
                <div class="container-fluid">
                    <h1 class="fw-bold p-2 fs-2 border-top border-3 w-50 mx-auto text-center pt-5 fw-bold"
                        id="principal">REFUGIOS DE ANIMALES</h1>
                    <div class="container mt-5">
                        <div class="row">
                            <div class="col-12">
                                <h2 class="text-center">Contactos de los Refugios de Animales de nuestra ciudad</h2>
                                <p class="text-center fs-5">Organizada por la Municipalidad de Cruz del Eje</p>

                                <h4 class="mt-4">Refugios de Animales</h4>
                                <ul class="sacarPelota">
                                    <li>
                                        <strong>Refugio:</strong> Refugio Animal Vida<br>
                                        <strong>Dirección:</strong> Calle Esperanza 101<br>
                                    ...
                                    <hr class="col-12">
                                    <li>
                                        <strong>Refugio:</strong> Hogar de Mascotas Felices<br>
                                        <strong>Dirección:</strong> Avenida Libertad 202<br>
                                    ...
                                    <hr class="col-12">
                                    <li>
                                        <strong>Refugio:</strong> Centro de Rescate Animal<br>
                                        <strong>Dirección:</strong> Calle Refugio 303<br>
                                    ...
                                    <hr class="col-12">
                                    <li>
                                        <strong>Refugio:</strong> Refugio Esperanza<br>
                                        <strong>Dirección:</strong> Avenida San Martín 404<br>
                                    ...
                                    <hr class="col-12">
                                    <li>
                                        <strong>Refugio:</strong> Casa de Animales<br>
                                        <strong>Dirección:</strong> Calle Principal 505<br>
                                    ...
                                    <hr class="col-12">
                                    <li>
                                        <strong>Refugio:</strong> Protección Animal<br>
                                        <strong>Dirección:</strong> Avenida Central 606<br>
                                    ...
                                    <hr class="col-12">
                                    <li>
                                        <strong>Refugio:</strong> Salvando Vidas<br>
                                        <strong>Dirección:</strong> Calle Segunda 707<br>
                                    ...
                                    <hr class="col-12">
                                    <li>
                                        <strong>Refugio:</strong> Animales en Casa<br>
                                        <strong>Dirección:</strong> Avenida Norte 808<br>
