...
<body id="page-top">
<header class="conteneiner-fluid bg-gradient-secondary d-flex justify-content-center fw-bold">
     ...
     <!-- Nav Item - User Information -->
        <li class="nav-item dropdown no-arrow">
         <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
             data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
             <span class="mr-2 d-none d-lg-inline text-light small"><?php echo $_SESSION['usuario_nombre'].' '. $_SESSION['usuario_apellido']; ?></span>
