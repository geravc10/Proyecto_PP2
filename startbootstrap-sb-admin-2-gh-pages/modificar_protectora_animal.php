...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!--FORMULARIO-->
    <h1 class="my-5 text-center fw-bold">Modificar Protectora Animal</h1>
    <form class="row g-3 m-4 my-5 p-3 mx-auto" id="formulario_E_Municipal">
        ...
        <div class="col-md-6">
            ...
            <input type="password" class="form-control" id="validationServer05" aria-describedby="validationServer05Feedback" placeholder="Especialidad">
