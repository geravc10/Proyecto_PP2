...
if(!empty($_POST['BotonAnimales'])){
    header('Location: informe_animales.php');
    exit;
}

if(!empty($_POST['BotonDuenos'])){
    header('Location: informe_duenos.php');
    exit;
}

if(!empty($_POST['BotonCampanas'])){
    header('Location: informe_campanas.php');
    exit;
}
...
text-white-50"></i> Generate Report</a>-->
                    ...
                    <h4 class="mb-4">Selecciona el informe que necesites ver:</h4>
                    <div class="row g-3">
                    <form action="" method="post">
                            <div class="col-12 text-center mt-4">
                                    <button class="btn btn-primary" type="submit" type="submit" value="modificar" name="BotonAnimales">Informe de Animales</button>
                                    <button class="btn btn-primary" type="submit" value="modificar" name="BotonDuenos">Informe de Dueños de Animales</button>
                                    <button class="btn btn-primary" type="submit" value="modificar" name="BotonCampanas">Informe de Campañas</button>
                            </div>
                    </form>
