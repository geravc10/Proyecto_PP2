...
class="card-img-top mx-auto mt-4 rounded" alt="Refugio de Animales"
id="servicio">
<div class="card-body">
...
class="card-img-top mx-auto mt-4 rounded" alt="Peluquero Canino"
id="servicio">
<div class="card-body">
...
<div class="col-lg-3 col-md-6 col-sm-12 mb-4">
<div class="card">
<img src="imagenes/historialMedicoAnimal.jpg"
class="card-img-top mx-auto mt-4 rounded" alt="Historial Médico Animal"
id="servicio">
<div class="card-body">
<h5 class="card-title">Historial Médico
Animal</h5>
<p class="card-text">Consulta informacion.</p>
<a href="#" class="btn btn-primary">CLICK
AQUI</a>
