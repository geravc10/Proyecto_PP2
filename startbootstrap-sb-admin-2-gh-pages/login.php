...
$UsuarioLogueado=DatosLogin($_POST['email'], $_POST['pass'],
$MiConexion);
...
$_SESSION['usuario_descripcion_nivel']=$UsuarioLogueado['Descripcion_ni
vel'];
...
- DueñoDeAnimal.jpg" alt="" class="img-fluid">
</div>
<div class="col-lg-6">
<div class="p-5">
<?php
...
name="recuerdame">
<label
class="custom-control-label" for="customCheck">Recuerdame</label>
</div>
</div>
<button class="btn btn-primary
btn-user btn-block"
type="submit"
value="Login" name="BotonLogin">
Ingresar
</button>
<hr>
</form>
...
<div class="text-center">
<a class="small"
href="forgot-password.html">No recuerdas la contraseña?</a>
</div>
<div class="text-center">
<a class="small"
href="register.php">Create una Cuenta!</a>
</div>
</div>
</div>
</div>
