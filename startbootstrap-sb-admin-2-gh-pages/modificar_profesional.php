...
<input type="text" class="form-control" id="nom_for"
...
<div class="col-md-6">
<label for="validationServer01"
class="form-label">Direccion del DNI</label>
<input type="text" class="form-control" id="nom_for"
placeholder="Direccion del Profesional" required>
<div class="valid-feedback">
Looks good!
</div>
</div>
...
<div class="col-md-6">
<label for="validationServer01"
class="form-label">Direccion del Local</label>
<input type="text" class="form-control" id="nom_for"
placeholder="Direccion del Local" required>
<div class="valid-feedback">
Looks good!
</div>
</div>
...
Habilitacion</label>
<input type="text" class="form-control" id="nom_for"
placeholder="N° Habilitacion" required>
<div class="valid-feedback">
Looks good!
</div>
</div>
