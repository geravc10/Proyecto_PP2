...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                  ...
                  <!--FORMULARIO-->
    <h1 class="my-5 text-center fw-bold">Modificar Profesional</h1>
    <form class="row g-3 m-4 my-5 p-3 mx-auto" id="formulario_E_Municipal">
        ...
        <div class="col-md-6">
            <label for="validationServer01" class="form-label">DNI</label>
            <input type="text" class="form-control" id="nom_for" placeholder="DNI" required>
            <div class="valid-feedback">
              Looks good!
            </div>
        </div>
        <div class="col-md-6">
            <label for="validationServer01" class="form-label">Direccion del DNI</label>
            <input type="text" class="form-control" id="nom_for" placeholder="Direccion del Profesional" required>
            <div class="valid-feedback">
              Looks good!
            </div>
        </div>
        <div class="col-md-6">
            <label for="validationServer01" class="form-label">Nombre del Local</label>
            <input type="text" class="form-control" id="nom_for" placeholder="Nombre del Local" required>
            <div class="valid-feedback">
              Looks good!
            </div>
        </div>
        <div class="col-md-6">
            <label for="validationServer01" class="form-label">Direccion del Local</label>
            <input type="text" class="form-control" id="nom_for" placeholder="Direccion del Local" required>
            <div class="valid-feedback">
              Looks good!
            </div>
        </div>
        <div class="col-md-6">
            ...
            <select class="form-select" id="validationServer04" aria-describedby="validationServer04Feedback" required>
              ...
              <option>Peluquero Canino</option>
        ...
        <div class="col-md-6">
            <label for="dateInput" class="form-label">Fecha de Creacion</label>
            <input type="date" class="form-control" id="validationServer05" aria-describedby="validationServer05Feedback" placeholder="Especialidad">
        ...
        <div class="col-md-4">
            <label for="validationServer01" class="form-label">N° Habilitacion</label>
