...
function ModificarVeterinario($vConexion){
...
//especialidad, habilitacion y estado
...
if($_POST['estado']==2){
    ...
    $SQL_Update="UPDATE 
                ...
                SET p.FECHA_DE_NACIMIENTO = '$fecha_nacimiento', p.ID_NACIONALIDAD = '$nacionalidad', 
                    ...
                    v.ID_ESPECIALIDAD='$especialidad', v.MATRICULA = '$habilitacion', v.ESTADO_VETERINARIO = $estado
