...
?>
<!-- Topbar -->
<nav class="navbar navbar-expand navbar-light <?php echo $color; ?>
...
<div>
<div class="small text-gray-500">December 12,
2019</div>
...
<div>
<div class="small text-gray-500">December 2,
2019</div>
...
<div class="text-truncate">Hi there! I am
wondering if you can help me with a
problem I've been having.</div>
<div class="small text-gray-500">Emily Fowler ·
58m</div>
</div>
</a>
<a class="dropdown-item d-flex align-items-center"
...
<div>
<div class="text-truncate">I have the photos that
you ordered last month, how
...
<div>
<div class="text-truncate">Last month's report
looks great, I am very happy with
the progress so far, keep up the good
work!</div>
<div class="small text-gray-500">Morgan Alvarez ·
2d</div>
</div>
</a>
<a class="dropdown-item d-flex align-items-center"
...
<div>
<div class="text-truncate">Am I a good boy? The
reason I ask is because someone
told me that people say this to all dogs, even
if they aren't good...</div>
<div class="small text-gray-500">Chicken the Dog ·
2w</div>
</div>
</a>
<a class="dropdown-item text-center small text-gray-500"
...
-->
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <span class="mr-2 d-none d-lg-inline <?php echo $letra;?> small"><?php echo $_SESSION['usuario_nombre'] . ' ' .
    $_SESSION['usuario_apellido']; ?></span>
