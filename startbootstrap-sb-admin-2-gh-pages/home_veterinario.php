...
<img src="imagenes/slider1.jpeg" class="d-block w-100"
alt="...">
</div>
<div class="carousel-item">
<img src="imagenes/slider4.jpeg" class="d-block w-100"
alt="...">
</div>
</div>
</div>
...
DueñoDeAnimal.jpg" class="figure-img img-fluid rounded" alt="..."
id="img_home_vete">
</a>
<figcaption class="figure-caption">CARGAR DUEÑO DE
ANIMAL</figcaption>
</figure>
</div>
<div class="col d-flex justify-content-center">
<figure class="figure text-center">
<a href="#">
<img src="imagenes/Home de Veterinario - Historial
Medico.jpg" class="figure-img img-fluid rounded" alt="..."
id="img_home_vete">
</a>
<figcaption class="figure-caption">CARGAR HISTORIAL
MEDICO</figcaption>
</figure>
</div>
<div class="col d-flex justify-content-center">
...
<img src="imagenes/Home de Veterinario - Animal de
la Calle.jpg" class="figure-img img-fluid rounded" alt="..."
id="img_home_vete">
</a>
<figcaption class="figure-caption">Animal de la
Calle</figcaption>
</figure>
</div>
</div>
...
<p>La campaña se llevará a cabo del <strong>1 al 15 de
junio</strong>, en los siguientes horarios:</p>
...
centros:</p>
<ul class="sacarPelota">
<li><strong>Centro Veterinario Municipal:</strong>
Calle Principal 123</li>
...
<p>Durante esta campaña, se ofrecerán las siguientes
vacunas para perros y gatos:</p>
<ul class="sacarPelota">
...
<p>Para recibir la vacunación, los propietarios deben
cumplir con los siguientes requisitos:</p>
<ul class="sacarPelota">
<li>Presentar el carné de vacunación del animal (si
lo tiene)</li>
<li>Llevar a los perros con correa y bozal, y a los
gatos en transportadora</li>
<li>Ser mayor de edad para firmar el consentimiento
de vacunación</li>
</ul>
...
<li>Contribución al control de enfermedades a nivel
comunitario</li>
</ul>
<p class="mt-4">¡No pierda esta oportunidad de proteger
a su mascota y mantenerla saludable! La vacunación es gratuita y
segura.</p>
